...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <div class="container"> <?php if (empty($politika_clanci)): ?> <p id="font">Nema članaka u ovoj kategoriji</p> <?php else: ?> <?php foreach ($politika_clanci as $clanak): ?> <div class="column">
      ...
      <h1>FOOD</h1>
      <div class="container"> <?php if (empty($hrana_clanci)): ?> <p id="font">Nema članaka u ovoj kategoriji</p> <?php else: ?> <?php foreach ($hrana_clanci as $clanak): ?> <div class="column2">
          <a class="test" href="podstranica.php?id=
														<?php echo $clanak['id']; ?>"> <?php if ($clanak['slika']): ?> <img class="clanakslika" src="
															<?php echo $clanak['slika']; ?>" alt=""> <?php endif; ?> <h2> <?php echo htmlspecialchars($clanak['naslov']); ?> </h2>
            <p> <?php echo htmlspecialchars($clanak['sazetak']); ?> </p>
